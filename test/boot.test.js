...
//
// O motivo de existir: um canal de IPC registrado duas vezes faz o Electron recusar o
// carregamento do main.js, e o programa sobe como processo sem nunca criar a janela.
// Esse teste pega justamente isso (registro repetido) e confere que o arquivo carrega.
//
...
const eletronFalso = {
  app: Object.assign(eventos(), {
    ...
    getVersion: () => '0.0.0-teste', getName: () => 'IdlePokeGrid', getAppPath: () => RAIZ, isPackaged: false,
  ...
  Tray: function () { return Object.assign(eventos(), { setToolTip() {}, setContextMenu() {}, setImage() {}, destroy() {} }); },
  ...
  nativeImage: { createFromPath: () => ({ isEmpty: () => false }), createFromDataURL: () => ({ isEmpty: () => false }) },
...
[['scrollLoginScript', 'const scrollLoginScript = `'], ['ecoScript', 'const ecoScript = (fps) => `']].forEach(([nome, marca]) => {
